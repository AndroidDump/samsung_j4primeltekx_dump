#!/system/bin/sh
if ! applypatch -c EMMC:/dev/block/bootdevice/by-name/recovery:18868752:01d68d720d860d5abd0d998c2ba26fd4aecec4c7; then
  applypatch EMMC:/dev/block/bootdevice/by-name/boot:14303760:225d1b15ecf5941a90848db70c8f38c4ca271c13 EMMC:/dev/block/bootdevice/by-name/recovery 01d68d720d860d5abd0d998c2ba26fd4aecec4c7 18868752 225d1b15ecf5941a90848db70c8f38c4ca271c13:/system/recovery-from-boot.p && log -t recovery "Installing new recovery image: succeeded" || echo 454 > /cache/fota/fota.status
else
